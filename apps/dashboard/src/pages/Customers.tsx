...
import { Plus, X, Users, Mail, Loader2, AlertCircle } from "lucide-react";
      ...
      <div style={{ background: "white", borderRadius: "16px", width: "100%", maxWidth: "400px", padding: "24px" }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <textarea style={{ ...inp, resize: "vertical", minHeight: "72px" }} value={notes} onChange={e => setNotes(e.target.value)} placeholder="Any notes about this customer…" />
          </div>
    ...
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 16px" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
        <div>
          ...
          <p style={{ fontSize: "14px", color: "#6b7280", marginTop: "4px" }}>{customers.length} total</p>
        </div>
      ...
      <div style={{ marginBottom: "16px" }}>
        <input style={{ ...inp, maxWidth: "320px" }} placeholder="Search by name or email…" value={search} onChange={e => setSearch(e.target.value)} />
      </div>
